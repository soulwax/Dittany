...
public class PlayerView {
	...
	private void centerOn(Mob u) {
		...
		scrollSteps = (int) (Math.sqrt(Math.sqrt(u.distanceToScreenSpaceSqr(xScroll + Dittany.WIDTH / 2, yScroll + Dittany.HEIGHT / 2))) / 2 + 1);
		xScrollT = xx - Dittany.WIDTH / 2;
		yScrollT = yy - Dittany.HEIGHT / 2;
	}
